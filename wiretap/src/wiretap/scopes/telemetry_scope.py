...
class TelemetryScope:
    ...
    def log_trace(
        ...
        # !! I want to have a single method that covers all possible usages to support maximum flexibility.
    ...
    def log_debug(
        ...
        # !! I want to have helper methods for frequently used traces.
    ...
    def push(
        ...
        # !! I want to be able to easily push a new telemetry-scope on the stack.
    ...
    def peek(cls) -> Optional["TelemetryScope"]:
        # !! I want to be able to easily peek the top telemetry-scope from the stack.
